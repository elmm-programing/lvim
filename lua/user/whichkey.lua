...
mappings["o"] = { "<cmd>AerialToggle!<cr>", "Outline" }
...
mappings["f"] = {
  ...
  s = { "<cmd>Telescope current_buffer_fuzzy_find<cr>", "Find in the same file" },
...
vmappings["b"] = { "<cmd>Telescope buffers<cr>", "Buffers" }
vmappings["v"] = { "<cmd>vsplit<cr>", "vsplit" }
vmappings["o"] = { "<cmd>AerialToggle!<cr>", "Outline" }
vmappings["q"] = { '<cmd>lua require("user.functions").smart_quit()<CR>', "Quit" }
vmappings["/"] = { '<cmd>lua require("Comment.api").toggle.linewise.current()<CR>', "Comment" }
vmappings["gy"] = "Link"
vmappings["h"] = {
  name = "Copilot Chat",
  o = { "<cmd>CopilotChatOpen<cr>", "Open Chat" },
